...
export interface RpcMethodMap {
  ...
  'llm.authStatus': LlmApi['authStatus']
  'llm.startAuth': LlmApi['startAuth']
  'llm.authOperation': LlmApi['authOperation']
  'llm.respondAuth': LlmApi['respondAuth']
  'llm.cancelAuth': LlmApi['cancelAuth']
