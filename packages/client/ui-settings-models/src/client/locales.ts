...
export const en = {
  nav: 'Models',
  title: 'Models',
  intro: 'Connect a provider or enter an API key to use its models.',
  edit: 'Edit',
  ...
  oauthConnected: 'Connected with OAuth',
  oauthNotConnected: 'OAuth not connected',
  oauthLogin: 'Connect',
  oauthStarting: 'Starting…',
  oauthLogout: 'Disconnect',
  oauthCancel: 'Cancel login',
  oauthDeviceInstruction: 'Enter this code on GitHub:',
  oauthOpenGitHub: 'Open GitHub verification',
  oauthContinue: 'Continue authentication',
  oauthWaiting: 'Waiting for authorization…',
  oauthSelect: 'Select an option',
  oauthSubmit: 'Continue',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  oauthConnected: '已通过 OAuth 连接',
  oauthNotConnected: '尚未连接 OAuth',
  oauthLogin: '连接',
  oauthStarting: '正在启动…',
  oauthLogout: '断开连接',
  oauthCancel: '取消登录',
  oauthDeviceInstruction: '在 GitHub 输入此代码：',
  oauthOpenGitHub: '打开 GitHub 验证页面',
  oauthContinue: '继续认证',
  oauthWaiting: '等待授权…',
  oauthSelect: '选择一项',
  oauthSubmit: '继续',
  oauthFailed: '认证失败。',
  oauthCancelled: '已取消认证。',
