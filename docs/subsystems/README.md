...
| [github-copilot-provider.md](github-copilot-provider.md) | the assembled `github-copilot` provider: plugin responsibilities, Device OAuth operations, credential persistence and refresh, failure behavior, and architecture fit |
