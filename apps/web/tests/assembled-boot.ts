...
const PLUGINS: readonly (WebBootEntry & { bundlePath: string })[] = [
  ...
  { id: '@deepseek-ai/dsh-client-ui-settings-general', bundlePath: 'packages/client/ui-settings-general/lib/client.js', url: '/plugins/ui-settings-general.js', rev: 'fx', inject: ['@deepseek-ai/dsh-client-runtime', '@deepseek-ai/dsh-client-ui-settings', '@deepseek-ai/dsh-client-locale', '@deepseek-ai/dsh-client-connection', '@deepseek-ai/dsh-api-remotes', '@deepseek-ai/dsh-client-ui-sidebar'] },
  { id: '@deepseek-ai/dsh-client-ui-settings-models', bundlePath: 'packages/client/ui-settings-models/lib/client.js', url: '/plugins/ui-settings-models.js', rev: 'fx', inject: ['@deepseek-ai/dsh-client-runtime', '@deepseek-ai/dsh-client-ui-settings', '@deepseek-ai/dsh-client-locale', '@deepseek-ai/dsh-api-remotes'] },
